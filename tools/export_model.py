...
'''
python tools/export_model.py -c configs/rec/rec_r32_gaspin.yml -o Global.pretrained_model=./output/rec/rec_r32_gaspin/latest Global.save_inference_dir=./output/rec/rec_r32_gaspin
'''